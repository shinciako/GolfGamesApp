...
class GameInfoFragment : Fragment() {
    ...
    private var shortGamesList = listOf(
        GameInfo("Par 18",0, Type.Short,"You play 9 holes from around the green. " +
                "The idea in this game is to make up and down from every ball. " +
                "See how many shots you need to complete 9 holes."),
        GameInfo("Bank",1,Type.Short, "Select 6 pins and your highest score is the" +
        ...
        GameInfo("Consecutive greens",2,Type.Mid, "This is a simple game. " +
